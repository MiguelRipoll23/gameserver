...
CREATE TABLE "server_signature_keys" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "server_signature_keys_singleton" CHECK ("id" = 1)
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "user_encryption_keys" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE UNIQUE INDEX "unique_lower_word" ON "blocked_words" (lower("word"));--> statement-breakpoint
CREATE INDEX "match_users_match_id_user_id_idx" ON "match_users" ("match_id","user_id");--> statement-breakpoint
CREATE INDEX "match_users_user_id_idx" ON "match_users" ("user_id");--> statement-breakpoint
ALTER TABLE "match_users" ADD CONSTRAINT "match_users_match_id_matches_id_fkey" FOREIGN KEY ("match_id") REFERENCES "matches"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "match_users" ADD CONSTRAINT "match_users_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "matches" ADD CONSTRAINT "matches_host_user_id_users_id_fkey" FOREIGN KEY ("host_user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "user_bans" ADD CONSTRAINT "user_bans_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "user_encryption_keys" ADD CONSTRAINT "user_encryption_keys_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "user_reports" ADD CONSTRAINT "user_reports_reporter_user_id_users_id_fkey" FOREIGN KEY ("reporter_user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "user_reports" ADD CONSTRAINT "user_reports_reported_user_id_users_id_fkey" FOREIGN KEY ("reported_user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "user_scores" ADD CONSTRAINT "user_scores_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
...
CREATE POLICY "authentication_challenges_all_delete" ON "authentication_challenges" AS PERMISSIVE FOR DELETE TO "authenticated_user" USING (true);--> statement-breakpoint
CREATE POLICY "refresh_tokens_select_own" ON "refresh_tokens" AS PERMISSIVE FOR SELECT TO "authenticated_user" USING ((current_setting('app.user_id', true)::uuid = "refresh_tokens"."user_id"));--> statement-breakpoint
CREATE POLICY "refresh_tokens_insert_own" ON "refresh_tokens" AS PERMISSIVE FOR INSERT TO "authenticated_user" WITH CHECK ((current_setting('app.user_id', true)::uuid = "refresh_tokens"."user_id"));--> statement-breakpoint
CREATE POLICY "refresh_tokens_delete_own" ON "refresh_tokens" AS PERMISSIVE FOR DELETE TO "authenticated_user" USING ((current_setting('app.user_id', true)::uuid = "refresh_tokens"."user_id"));--> statement-breakpoint
...
CREATE POLICY "user_encryption_keys_select_own" ON "user_encryption_keys" AS PERMISSIVE FOR SELECT TO "authenticated_user" USING ((current_setting('app.user_id', true)::uuid = "user_encryption_keys"."user_id"));--> statement-breakpoint
CREATE POLICY "user_encryption_keys_insert_own" ON "user_encryption_keys" AS PERMISSIVE FOR INSERT TO "authenticated_user" WITH CHECK ((current_setting('app.user_id', true)::uuid = "user_encryption_keys"."user_id"));--> statement-breakpoint
CREATE POLICY "user_encryption_keys_update_own" ON "user_encryption_keys" AS PERMISSIVE FOR UPDATE TO "authenticated_user" USING ((current_setting('app.user_id', true)::uuid = "user_encryption_keys"."user_id")) WITH CHECK ((current_setting('app.user_id', true)::uuid = "user_encryption_keys"."user_id"));--> statement-breakpoint
CREATE POLICY "user_encryption_keys_delete_own" ON "user_encryption_keys" AS PERMISSIVE FOR DELETE TO "authenticated_user" USING ((current_setting('app.user_id', true)::uuid = "user_encryption_keys"."user_id"));--> statement-breakpoint
